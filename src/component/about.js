...
import POSTER_IMG_1 from '../images/poster/1.webp';
import POSTER_IMG_2 from '../images/poster/2.webp';
import POSTER_IMG_3 from '../images/poster/3.webp';
// import POSTER_IMG_4 from '../images/poster/4.webp';
// import POSTER_IMG_5 from '../images/poster/5.webp';
// import POSTER_IMG_6 from '../images/poster/6.webp';
                                                ...
                                                <ul className="uk-slider-items"> 
                                                   <li className="uk-width-1-1">
                                                        <div className="uk-card uk-card-default uk-padding uk-width-1-1@m">
                                                            ...
                                                            <p className='uk-margin-small'>Date : 01-June-2023</p>
                                                    ...
                                                    <li className="uk-width-1-1">
                                                        <div className="uk-card uk-card-default uk-padding uk-width-1-1@m">
                                                            ...
                                                            <p className='uk-margin-small'>Date : 10-June-2023</p>
                                                            <div class="uk-clearfix uk-text-center">
                                                                <div class="uk-float-left">
                                                   ...
                                                   <li className="uk-width-1-1">
                                                        <div className="uk-card uk-card-default uk-padding uk-width-1-1@m">
                                                            <b className='uk-margin-small'>Pradosham</b>
                                                            <p className='uk-margin-small'>Date : 15-June-2023</p>
                                                            <div class="uk-clearfix uk-text-center">
                                                                <div class="uk-float-left">
                                                                ...
                                                                <div class="uk-float-right">
                                                                <button class="uk-button uk-margin-small-right" type="button" data-uk-toggle="target: #modal-poster-3"><img src="https://img.icons8.com/windows/32/FFFFFF/visible--v1.png" alt='view icon'/></button>
                                                    ...
                                                    {/* <li className='uk-width-1-1'>
                                                        <div className="uk-card uk-card-default uk-padding uk-width-1-1@m">
                                                            ...
                                                            <p className='uk-margin-small'>Date : 11-May-2023</p>
                                                            <div class="uk-clearfix uk-text-center">
                                                                <div class="uk-float-left">
                                                                    <a href={ POSTER_IMG_3 } download="Brochure.jpeg"  loading="lazy" className='custom-align-center' style={{textDecoration:'none'}}>
                                                                        <button className='uk-button uk-margin-small-right' type='button'>
